        ...
        <div className="guide-layout">
          ...
          <article className="guide-article">
            ...
            <section id="read-first">
              ...
              <p>
                So let's fix the root. By the end of this you should be able to look at any
                business (yours, your friend's, a stranger's) and see the machine underneath. The
                same machine is under all of them. A landscaping company, a law firm, a SaaS
                startup, and a taco truck are the same machine wearing different clothes.
              </p>
              ...
              <p>
                One scope note: this covers how the machine works. It does not cover legal
                structure, taxes in detail, licenses, or insurance. Those vary by location; ask a
                local accountant. What's here is true everywhere.
              </p>
            </section>
            ...
            <section id="part-1">
              ...
              <p>
                ...
                make a problem go away. The dentist doesn't sell drilling; he sells "the pain
                stops" and "I'm not embarrassed to smile." Even lawyers billing by the hour aren't
                selling hours. The client pays for the contract reviewed or the lawsuit survived,
                and tolerates hourly billing as the meter. The moment the hours stop producing the
              ...
              <p>
                <strong>"At a cost lower than what they'll pay you."</strong> This gap is the
                entire point. It's called <strong>margin</strong>, and Part 4 measures it
                precisely. Costs you $40 to solve, they pay $100: you made $60 of value that didn't
                exist before. Not theft, not luck. It's the reward for solving the problem cheaper
                than they could solve it themselves. Business is the act of manufacturing that gap
                and keeping it.
              </p>
              <p>
            ...
            <section id="part-2">
              ...
              <p>
                ...
                Attention comes three ways. You can <strong>rent it</strong> (ads, which stop
                working the moment you stop paying). You can <strong>earn it</strong> (referrals,
                reviews, reputation: slow to build, cheap to keep). Or you can{' '}
                <strong>own it</strong>: a list of people who already know you, in the form of
                phone numbers, emails, and followers. The owned list is the most valuable asset
                most small businesses never bother to build. No attention, no business. A perfect
                product nobody hears about makes exactly zero dollars.
              </p>
              <p>
              ...
              <p>
                ...
                labor, ads, rent, <em>and your own wage</em>. That last one is the detail most
                owners get wrong, and Part 4 fixes it. If the loop costs more than it collects, you
                have an expensive way to lose money with extra steps.
              </p>
              <p>
                ...
                growth problem. It has a "how fast can I pour in dollars" problem. That is the only
                good problem in business.
              </p>
              <p>
            ...
            <section id="part-3">
              ...
              <p>
                Zoom in and every business, no exceptions, is four jobs running at once. "Running a
                business is overwhelming" means the four jobs were never separated, so they feel
                like one giant blob. Separate them and the blob becomes four manageable things,
              ...
              <p>
                ...
                <strong>conversion rate</strong> (the fraction of leads who buy; 10 leads, 3 buy,
                30%) and <strong>average sale size</strong>. A business can double revenue without
                a single new lead just by getting better at this job. Most owners never realize
                that.
              </p>
              <p>
              ...
              <p>
                ...
                is the hardest and most expensive you'll ever make to them. The second is cheap.
                The output is <strong>lifetime value</strong>: what a customer is worth across the
                whole relationship, defined in Part 4. This is the most profitable job in business,
                and the one small businesses neglect most.
              </p>
              <p>
                The map to Part 2: Job 1 is "get attention," Job 2 runs "make an offer" through
                "get paid," Job 3 is "deliver," Job 4 makes "over and over again" true. Same
                machine, two zoom levels.
              </p>
              <p>
                Write the four down. Which is your business worst at right now? That's your
                constraint, and the constraint is Part 6's subject.
              </p>
            </section>
            ...
            <section id="part-4">
              ...
              <p>
                ...
                <em>if the sale doesn't happen, does the cost disappear?</em> Yes means cost of
                delivering. No means fixed cost.
              </p>
              <p>
                ...
                <strong>Margin percent</strong> (60%) says how efficiently revenue becomes fuel,
                and survives price changes for comparison. This is why two businesses with
                identical revenue live in different universes: one keeps $60 per sale, the other
                $10.
              </p>
              <p>
              ...
              <p>
                ...
                do your job in the business (the market wage for the operator role) and count it as
                a fixed cost <em>before</em> calculating profit. A business that only "makes money"
                because the owner works free isn't profitable; it's a badly paying job with extra
                risk. Can't afford to pay yourself yet? Fine. Early businesses often can't. But
                write the unpaid wage down as the real number it is, and aim the machine at closing
                the gap. Don't let "we're profitable!" mean "I paid everyone but me."
              </p>
              <p>
                ...
                more honesty check: that's pre-tax. Set aside a percentage every month, at the rate
                your accountant gives you, so April isn't a heart attack.)
              </p>
              <p>Now the two ratios that decide whether you live or die.</p>
              <p>
                <strong>CAC, the cost to acquire a customer.</strong> Everything spent getting
              ...
              <p>
                One precision most guides skip: there are two CACs. <strong>Paid CAC</strong>{' '}
                counts only customers from paid channels, against what you paid.{' '}
                ...
                look beautifully low, and that low number says nothing about whether your ads work.
                Paid CAC judges a channel. Blended CAC judges the business.
              </p>
              <p>
                ...
                customers leave, and it's the silent killer inside every LTV. Halve how long
                customers stay and you halve LTV without touching price or cost.
              </p>
              <div className="guide-eq">
                <p>
              ...
              <p>
                ...
                <strong>margin on the single sale ≥ 3× CAC.</strong> Referrals become your whole
                Job 4. The repeat purchase you're owed is the customer's brother-in-law.
              </p>
              <p>
                <em>Money comes in slowly</em> ($800 over 20 months)? Also track{' '}
                <strong>payback period</strong>: months until a customer's accumulated margin
                covers their CAC. CAC $100, margin $40/month: payback 2.5 months. Shorter is safer,
                because of what's next.
              </p>
              <p>
                <strong>Cash.</strong> Profit is a number on a page. Cash is what's in the bank
                today. You can be profitable on paper and die anyway: you paid for materials in
                March, the customer paid you in June, and payroll was due in April. A business
                doesn't die when it stops being profitable. It dies when it runs out of cash. Those
                are not the same day.
              </p>
              <p>
                Measure cash as <strong>runway</strong>: bank balance ÷ monthly fixed costs =
                months you'd survive if sales stopped. Three months is a floor; six is comfortable.
                And know the three levers that move cash without touching profit.{' '}
                <strong>Collect sooner</strong>: deposits, invoice the day the job finishes, card
                on file, shorter terms. <strong>Pay later</strong>: ask suppliers for terms; many
                say yes if asked. <strong>Hold less stock</strong>: inventory is cash sleeping on a
            ...
            <section id="part-5">
              ...
              <p>
                ...
                invented, from ads and scripts to upsells, loyalty programs, and price changes, is
                an attempt to move one of those six. When someone pitches you anything, ask:{' '}
              ...
              <p>
                ...
                Improve leads 10%, conversion 10%, average sale 10% (three modest wins) and revenue
                grows 1.1 × 1.1 × 1.1 = <strong>33%</strong>, not 30%. The reverse is how
              ...
              <p>
                <strong>If a number is multiplied by zero, then everything is zero.</strong>{' '}
                Perfect conversion times zero leads is zero customers. The world's best product
                times zero attention is zero revenue. Find your zero before polishing anything
                else.
              </p>
              <p>
                <strong>
                ...
                pouring in leads. (This is Part 12's whole argument, previewed.)
              </p>
              <p>
            ...
            <section id="part-6">
              ...
              <p>
                ...
                <em>other</em> section does nothing. Find the narrow part, widen it, and a
                different section becomes narrowest. Move there. One at a time. Forever. That's
                what "running a business" actually is, day to day.
              </p>
              <p>
              ...
              <ul>
                ...
                <li>
                  ...
                  (busy because underpriced; see Part 9) or <strong>waste</strong> (paying for
                  minutes the customer isn't; see Skill 2).
                </li>
                <li>
                  Selling fine, but refunds, callbacks, bad reviews → <strong>delivery</strong>{' '}
                  (Job 3).
                </li>
                <li>
                ...
                <li>
                  Every number fine, bank account still scared → <strong>cash timing</strong>{' '}
                  (Part 4's levers) or <strong>fixed costs</strong>.
                </li>
              </ul>
              <p>
                <strong>
            ...
            <section id="part-7">
              ...
              <ul>
                ...
                <li>
                  ...
                  customer with a solved problem. Not 30 steps. The height at which you'd explain
              ...
              <p>
                ...
                <em>
                  stranger hears of us → contacts us → gets a quote → says yes → we deliver → we
                  get paid → we follow up.
                </em>{' '}
              ...
              <p>
                ...
                name, an owner, and a gauge. You stop saying "business is slow," which is a
                feeling, and start saying "step 3 converts at 15%, down from 30%," which is a fact
                with an address.
              </p>
              ...
              <p>
                ...
                seeing the difference in your own day, which is hard, because waste feels like
                work. Being busy is the most virtuous-feeling thing in business.
              </p>
              <p>
              ...
              <p>
                ...
                sleeping on shelves, or iron sleeping in the yard.{' '}
              ...
              <p>
                ...
                <strong>Exercise:</strong> compute all eight scoreboard numbers (Part 14) this
                week. Any you can't compute, go measure.
              </p>
              ...
              <p>
                Part 6 in one line: locate the narrowest point, widen only that, repeat. Listed
                here because it belongs in the set you drill. <strong>Exercise:</strong> run Part
                6's procedure quarterly, on the calendar, like a dentist appointment for the
                business.
              </p>
              ...
              <p>
                Symptoms are loud; causes are quiet. Refuse to fix the symptom until you've
                followed the chain to the cause. Ask why, then ask why about the answer, about five
                times, until you hit something you can permanently change.
              </p>
              <p>
                ...
                heals. Fix the symptom instead (a discount to win the unhappy contractor's next
                job) and you'll pay forever for a problem that's still there.
              </p>
              ...
              <p>
                Every business guide says "build systems." Almost none says what a system
                physically <em>is</em>, which lets owners nod along for years without building one.
              ...
              <p>
                ...
                every night at 5pm. <strong>Exercise:</strong> take the one task you'd least like
                to re-explain to a new hire and write the checklist <em>while doing it</em>.
                During, not after. After is how steps get forgotten. Your business now contains one
                system. Part 11 shows why this unglamorous skill is the exit door from owning a
                job.
              </p>
              <p>
            ...
            <section id="part-8">
              ...
              <p>
                ...
                think value means cheap. It doesn't. Value is what someone gets versus what it
                costs them to get it, and "cost" is much more than money. Four levers: two to push
                up, two to push down.
              </p>
              <p>
              ...
              <p>
                ...
                does the customer carry? "Done for you" beats "done with you" beats "do it
                yourself," and commands a higher price at each step, because you took effort off
                their side of the scale. People pay enormous sums to not have to do something.
              </p>
              <p>
                ...
                Price was the only dial they knew existed. Move the levers and price stops being
                the conversation.
              </p>
              <p>
            ...
            <section id="part-9">
              ...
              <p>
                ...
                for a struggling business, and unlike every other improvement it needs no new
                skill, staff, or spend.
              </p>
              <p>
                <strong>The asymmetry.</strong> Sell at $100 with $40 delivery cost: keep $60.
                Raise 30% to $130: cost is still $40, keep $90. Price up 30%; profit per sale up{' '}
              ...
              <p>
                <strong>The breakeven formula, so you can stop fearing lost customers.</strong> A
                raise may cost you some. Here's exactly how many you can afford to lose:
              </p>
              <div className="guide-eq">
              ...
              <p>
                ...
                30% raise that loses 15% of customers: 100 × $60 = $6,000 of margin before; 85 ×
                $90 = <strong>$7,650</strong> after. More money, fewer headaches. The customers who
                leave over a fair increase are disproportionately your most demanding,
                lowest-margin ones. (Not always. Occasionally a price-savvy <em>good</em> one
                walks, which is why you test instead of leap.)
              </p>
              ...
              <ol>
                <li>
                  ...
                  customer. Your price lives between them. For most undercharging owners, it lives
                  far closer to the ceiling than they think.
                </li>
                <li>
            ...
            <section id="part-10">
              ...
              <p>
                ...
                customers a year. Ten a month. <strong>One every three days.</strong> The goal
                isn't "go viral" or "beat the whole market." It's "find one customer every three
                days," a completely different, completely doable problem.
              </p>
              <p>
              ...
              <p>
                ...
                higher value per customer → fewer needed → more attention for each → better
                delivery → more referrals → even fewer cold leads to chase. The high-volume,
                low-price game grinds owners into dust. This loop is the refusal to play it.
              </p>
              <p>
            ...
            <section id="part-11">
              ...
              <p>
                ...
                the system keeps producing after you've gone home. This is{' '}
                <strong>leverage</strong>, meaning more output from the same input. The richest,
                freest owners aren't the hardest workers. They built machines that produce whether
                or not they touched anything today.
              </p>
              <p>
              ...
              <ol>
                ...
                <li>
                  <strong>Watch them once.</strong> Wherever they stumble, fix the{' '}
              ...
              <p>
                Each pass permanently buys back hours of your week. Your hours are the scarcest,
                most expensive resource in the company. Spend the recovered ones only on things
                that compound: the constraint, the offer, the systems, the key hires.
              </p>
              <p>
              ...
              <p>
                ...
                survive? Every system written and task handed off moves the answer toward yes.
                "Yes" is what makes a business sellable, restable, survivable. (And per Part 12,
                this is the <em>fifth</em> step of building a business, not the first. Pre-profit,
                you're supposed to still be the machine. No guilt. Just don't retire there.)
              </p>
            </section>
            ...
            <section id="part-12">
              ...
              <p>
                When everything feels broken, people freeze. Here's the order to fix things in.
                Each step assumes the one before it. Skipping ahead doesn't make you fast; it
                multiplies a broken machine.
              </p>
              <p>
                ...
                system will save you. You don't have a problem worth solving yet, or you're
                offering it to the wrong group. Fix the offer or the audience.
              </p>
              <p>
              ...
              <p>
                ...
                after <em>all</em> its real costs, including your time at a real wage. Lose money
                on one and you'll lose more on a hundred. This is the step everyone skips, and why
                "we grew and went broke" is such a common story.
              </p>
              <p>
              ...
              <p>
                ...
                capacity. Scaling before this point multiplies a broken machine; after it, a
                working one. Same action, opposite result. The only difference is the order.
              </p>
              <p>
            ...
            <section id="part-13">
              ...
              <p>
                ...
                demanding customers set the price for everyone. Run the breakeven formula before
                you run the fear.
              </p>
              <p>
                ...
                mediocre product everybody hears about, every time. Attention is a job, not a
                reward good work earns automatically.
              </p>
              <p>
                <strong>"More revenue will fix it."</strong> If each sale loses money, more revenue
                digs faster. Margin first, then volume. Revenue hides profit problems right up
                until it can't.
              </p>
              <p>
                ...
                you can afford more. Staying solo to save money can be the most expensive choice
                you make.
              </p>
              <p>
            ...
            <section id="part-14">
              ...
              <p>
                ...
                numbers. Weekly. That's the whole discipline. Where each comes from is listed, so
                "I don't have that data" lasts exactly one week:
              </p>
              <ol>
                <li>
                ...
                <table className="guide-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        Pick ONE channel and work it weekly; ask every happy customer for a
                        referral by name; build the owned list (Part 2)
                      </td>
                    </tr>
                    <tr>
            ...
            <section id="part-15">
              ...
              <p>
                <strong>The driver tree (Part 5, Skill 3).</strong> Cost of delivering one ton:
                fuel $1.20, wear parts and maintenance $0.90, operator labor $0.90, mobilization
                ...
                costs: equipment finance $33,000 (the iron gets paid whether it crushes or
                sleeps), insurance, shop, and office $5,000, and Ray's operator wage $10,000 (in
                fixed costs, where it belongs; see Part 4). Total: <strong>$48,000</strong>.
                Profit: $48,000 − $48,000 = <strong>zero</strong>. A $1.4-million-a-year company
                earning nothing. And Ray <em>feels</em> profitable, because his wage masks it. Part
                4's honest arithmetic just earned its keep.
              </p>
              <p>
              ...
              <p>
                ...
                Five whys (Skill 5): <em>the spread sits idle.</em> Why? The next job isn't lined
                up when the current one ends. Why? Quotes go out a week late. Why? Ray prices every
                bid himself, at night, after running a loader all day. Why? There's no rate sheet;
              ...
              <p>
                ...
                report (tonnage, gradation specs, photos) plus a tracked call when each
                contractor's next project breaks ground. Average relationship grows from 3 jobs to
                5: LTV rises from $90,000 to <strong>$150,000</strong>. A kept contractor costs a
                phone call; a replaced one costs $3,000 and a bid cycle.
              </p>
              <p>
              ...
              <p>
                ...
                constraint moves to capacity. Napkin math: a second spread adds ~20,000 tons a
                month × $2.90 ≈ $58,000 of margin against roughly $38,000 of new fixed costs:
                about <strong>$20,000 a month</strong>. And it pencils <em>only because</em> the
                rate sheet, the follow-up system, and the maintenance schedule already exist. Note
                the order: buying more iron <em>before</em> fixing idle days would have doubled the
                ...
                <em>on</em> the machine, and the vacation test gets closer to "yes" every quarter.
              </p>
              <p>
                ...
                seeing the machine: drawing it, reading its eight numbers, finding the one
                narrowest point, fixing that, repeating. Every move was arithmetic before it was
                action.
              </p>
            </section>
            ...
            <section id="napkin">
              ...
              <p>
                ...
                charge more than you're comfortable with by being worth more than you're
                comfortable with, and remember you need fewer customers than you fear. The end goal
                is a machine that runs without you, because that's the difference between owning a
              ...
              <BookCta
                ...
                sub="Book a free 30-minute Operations Review. We'll run your real numbers through the scoreboard and you'll walk out with your constraint named and a first project to attack it."
              />
            </section>
          </article>
        </div>
