/**
 * Central site constants — edit links/assets in one place.
 */

// Canonical booking link — 30-min Free Operations Review.
export const BOOKING_URL = 'https://leandirt.co/TYWjkBF';

/**
 * Brand images.
 * TODO (before cancelling HubSpot): save the three photos below into /public/img
 * as hero-field.jpg, crew-plans.jpg, zack-speaking.jpg — then switch each value
